...
FILES = utils/actions.c utils/basic_.c utils/counters.c utils/errors.c \
	utils/insertD.c utils/insertion_utils.c utils/push_swap_utils.c utils/sort_utils.c
